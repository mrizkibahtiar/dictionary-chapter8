...
cxn_str = 'mongodb+srv://testSparta:testSparta@cluster0.7wix7.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'
...
def detail(keyword):
    ...
    # Jika API hanya mengembalikan saran kata
...
def delete_ex():
    ...
    return jsonify({
        'result': 'success',
        'msg': 'The example was deleted successfully.',
    })
